...
### Improved
- Fixed Credit Notes and Vendor Credits import visibility so import actions use import permissions, and Vendor Credits no longer appears as Debit Notes in the page header.
