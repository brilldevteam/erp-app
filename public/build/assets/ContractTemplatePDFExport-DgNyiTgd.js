...
import{_ as m}from"./app-DSMfeqOy.js";import{$ as e}from"./ui-BPUUO-e7.js";import{B as c}from"./button-CN5-FRd-.js";import{T as f,c as b,a as g}from"./tooltip-DKc79Er6.js";import{b as x,c as n}from"./helpers-CMvbr1Vc.js";import{u as h}from"./useTranslation-Dp56GW0M.js";import{D as v}from"./download-CrFZZ81H.js";/* empty css            */import"./index-I7g51jjI.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-CmeZxMYV.js";import"./index-BbpkoFKA.js";import"./createLucideIcon-BITY8JvQ.js";function S({template:t,variant:s="outline",size:a="sm"}){const{t:o}=h(),p=()=>{var r;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const d={margin:.5,filename:`contract-template-${t.template_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};m(()=>import("./html2pdf-ZB6yVBWn.js").then(i=>i.h),__vite__mapDeps([0,1,2,3,4]),import.meta.url).then(i=>{i.default().set(d).from(l).save()})};return e.jsxs(f,{children:[e.jsx(b,{asChild:!0,children:e.jsx(c,{variant:s,size:a,onClick:p,children:e.jsx(v,{className:"h-4 w-4"})})}),e.jsx(g,{children:e.jsx("p",{children:o("Download PDF")})})]})}export{S as default};
