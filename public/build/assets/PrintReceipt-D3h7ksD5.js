import{c as x,h as y,b as o}from"./helpers-dMT_p4Zy.js";import"./app-P2ejYCRC.js";import"./ui-BPUUO-e7.js";const $=(a,i)=>{var p,s,d,m;const f=`
    <!DOCTYPE html>
    <html>
    <head>
    ...
    `,t=document.createElement("iframe");t.style.display="none",document.body.appendChild(t);const e=t.contentDocument||((s=t.contentWindow)==null?void 0:s.document);e&&(e.write(f),e.close(),(d=t.contentWindow)==null||d.focus(),(m=t.contentWindow)==null||m.print(),setTimeout(()=>{document.body.removeChild(t)},1e3))};export{$ as printReceipt};
