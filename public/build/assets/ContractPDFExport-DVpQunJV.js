const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-ZB6yVBWn.js","./ui-BPUUO-e7.js","./app-DSMfeqOy.js","./app-CQG9E_-B.css","./app-DQSMvtwW.css"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-DSMfeqOy.js";import{$ as i}from"./ui-BPUUO-e7.js";import{B as x}from"./button-CN5-FRd-.js";import{T as f,c as b,a as h}from"./tooltip-DKc79Er6.js";import{b as v,c as n,e as p}from"./helpers-CMvbr1Vc.js";import{u as _}from"./useTranslation-Dp56GW0M.js";import{D as y}from"./download-CrFZZ81H.js";/* empty css            */import"./index-I7g51jjI.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-CmeZxMYV.js";import"./index-BbpkoFKA.js";import"./createLucideIcon-BITY8JvQ.js";function A({contract:e,variant:s="outline",size:d="sm"}){const{t}=_(),a=()=>{var r;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-ZB6yVBWn.js").then(o=>o.h),__vite__mapDeps([0,1,2,3,4]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:d,onClick:a,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{A as default};
