                ...
                'content' => '<div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white border rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">What is Wazely ERP?</h3>
                            <p class="text-gray-600 leading-relaxed">Wazely ERP is a comprehensive business management platform that helps companies streamline their operations, manage projects, and improve productivity through integrated tools and modules.</p>
                        </div>
                        ...
                        <div class="bg-white border rounded-lg p-6">
                            ...
                            <p class="text-gray-600 leading-relaxed">Yes! Wazely ERP offers extensive customization options including custom fields, workflows, dashboards, and integrations with third-party tools.</p>
                        </div>
                    </div>
