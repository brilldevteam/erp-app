...
class LandingPageSettingSeeder extends Seeder
{
    ...
    private function getDefaultSections(): array
    {
        return [
            'hero' => [
                'variant' => 'hero1',
                'title' => 'Transform Your Business with Wazely ERP',
            ...
            'gallery' => [
                'variant' => 'gallery1',
                'title' => 'See Wazely ERP in Action',
            ...
            'cta' => [
                ...
                'subtitle' => 'Join thousands of businesses already using Wazely ERP to streamline their operations.',
                'primary_button' => 'Start Free Trial',
                'secondary_button' => 'Contact Sales'
            ],
            'addons' => [
                'title' => 'Premium Addons',
                'subtitle' => 'Extend your Wazely ERP with powerful premium modules designed to enhance your business operations',
                'per_page' => 20,
