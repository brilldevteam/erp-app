...
use Workdo\RecurringInvoiceBill\Console\RecurringSalesPurchaseCommand;
...
class RecurringInvoiceBillServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            RecurringSalesPurchaseCommand::class,
        ]);
    }
    ...
    protected function registerCommandSchedules(): void
    {
        $this->app->booted(function () {
            ...
            $schedule->command('recurring:sales-purchase-invoices')->daily();
        });
    }
    /**
