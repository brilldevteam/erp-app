...
export default function Show() {
    ...
    const spreadsheetButtons = usePageButtons('spreadsheetBtn', { module: 'Contracts', id: contract?.id });
    const businessProcessMappingButtons = usePageButtons('businessProcessMappingBtn', { module: 'Contract', submodule: 'Contracts', id: contract.id });
