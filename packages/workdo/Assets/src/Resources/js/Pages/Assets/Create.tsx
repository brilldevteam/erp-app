        ...
        <DialogContent>
            ...
            <form onSubmit={submit} className="space-y-4">
                ...
                <div>
                    ...
                    {locations?.length === 0 && (
                        <p className="text-xs text-gray-500 mb-1">
                            {t('Create location here.')} <button type="button" onClick={() => window.open(route('assets.locations.index'), '_blank')} className="text-blue-600 hover:underline">{t('Create location')}</button>
                        </p>
                    )}
