...
const summaryKeys: Record<Kind, string[]> = {
    ...
    deliverable: ['content_name', 'content_type', 'episodes_reels_count', 'current_status', 'final_delivery_date'],
};
