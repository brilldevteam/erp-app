                            ...
                            <CardContent className="p-6">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {auth.user?.permissions?.includes('import-revenue-categories') && auth.user?.permissions?.includes('create-revenue-categories') && (
                                            <BulkImportButton entity="revenue-categories" label={t('Revenue Categories')} />
                                        )}
