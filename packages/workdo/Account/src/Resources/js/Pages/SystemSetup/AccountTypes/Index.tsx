                            ...
                            <CardContent className="p-6">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {auth.user?.permissions?.includes('import-account-types') && auth.user?.permissions?.includes('create-account-types') && (
                                            <BulkImportButton entity="account-types" label={t('Account Types')} />
                                        )}
