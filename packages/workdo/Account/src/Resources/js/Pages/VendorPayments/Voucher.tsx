...
export default function Voucher() {
    ...
    return (
        <div className="min-h-screen bg-slate-100 py-6 print:bg-white print:py-0">
            ...
            <div className="vendor-payment-voucher relative mx-auto min-h-[10.5in] max-w-4xl overflow-hidden bg-white p-12 text-sm text-slate-900 shadow-sm print:shadow-none">
                ...
                <section className="grid grid-cols-1 gap-12 border-b py-12 md:grid-cols-[1fr_1.1fr]">
                    <div className="space-y-10 md:border-r md:pr-12">
                        <div>
                            <div className="font-serif text-base font-semibold text-slate-600">{t('Amount Paid')}</div>
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-slate-100 p-6">
            ...
            <div className="max-w-lg rounded-lg bg-white p-8 text-center shadow-sm">
                ...
                <p className="mt-3 text-slate-600">{t('Please create an active Payment template before downloading vendor payment vouchers.')}</p>
