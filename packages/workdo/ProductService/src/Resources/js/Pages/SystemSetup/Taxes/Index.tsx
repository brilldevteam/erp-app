                            ...
                            <CardContent className="p-6">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {auth.user?.permissions?.includes('import-product-service-taxes') && auth.user?.permissions?.includes('create-product-service-taxes') && (
                                            <BulkImportButton entity="product-service-taxes" label={t('Taxes')} />
                                        )}
