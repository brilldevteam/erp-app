...
class ExpenseCategoryDefinition implements EntityDefinition
{
    use NormalizesImportValues;
    use ResolvesImportReferences;

    public function key(): string { return 'expense-categories'; }
    public function permission(): string { return 'import-expense-categories'; }
    public function createPermission(): string { return 'create-expense-categories'; }
    ...
    public function aliases(): array { return ['category_name' => ['name', 'expense_category'], 'category_code' => ['code'], 'chart_of_account' => ['gl_account', 'account']]; }
    public function example(): array { return ['Office Supplies', 'EXP-OFFICE', '5300', 'Office supply expenses', 'yes']; }
    ...
    public function import(array $row, string $strategy, int $tenantId, int $actorId): string
    {
        ...
        ExpenseCategories::create($values + ['creator_id' => $actorId, 'created_by' => $tenantId]);
        return 'imported';
    }

    private function findCategory(array $row, int $tenantId): ?ExpenseCategories
    {
