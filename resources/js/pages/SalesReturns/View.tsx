                        ...
                        <div className={`grid grid-cols-1 gap-6 ${salesReturn.customer_details?.billing_address || salesReturn.customer_details?.shipping_address ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
                            <div>
                                ...
                                {salesReturn.customer_details?.billing_address && (
                                    <div className="mt-3">
                                        ...
                                        <AddressDisplay address={salesReturn.customer_details.billing_address} className="space-y-1 text-sm text-muted-foreground" />
                                    </div>
                                )}
                            </div>
                            ...
                            {salesReturn.customer_details?.shipping_address && (
                                <div>
                                    ...
                                    <AddressDisplay address={salesReturn.customer_details.shipping_address} className="space-y-1 text-sm text-muted-foreground" />
                                </div>
                            )}
